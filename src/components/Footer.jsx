...
const footerColumns = [
  {
    title: "Explore",
    links: ["Home", "Categories", "New Releases", "Best Sellers", "Authors"],
  },
  {
    title: "Resources",
    links: ["Blog", "Reading Guides", "Events", "Gift Cards", "FAQ"],
  },
  {
    title: "Company",
    links: [
...
const legalLinks = ["Cookie Settings", "Accessibility"];
...
export default function FooterNewsletter() {
  return (
    <footer className="bg-background text-foreground relative w-full pt-20 pb-10 text-white">
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="text-foreground/70 mb-6">
                Join thousands of readers discovering amazing stories, timeless
                classics, and the latest releases.
              </p>
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                />
                <button className="subscribe-button cursor-pointer text-primary-foreground shadow-primary/20 hover:shadow-primary/30 rounded-lg px-6 py-3 font-medium shadow-lg transition">
                  Subscribe Now
                </button>
              </div>
            </div>
